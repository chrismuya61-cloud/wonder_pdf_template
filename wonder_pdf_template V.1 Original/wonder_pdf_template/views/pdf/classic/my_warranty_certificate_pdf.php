...
<td style="text-align:right;"><h1 style="padding:0; margin:0; font-size:40px;">' . strtoupper(_l('warranty_certificate')) . '</h1></td>
</tr>
</tbody>
</table>';
...
<p>This warranty applies to products, manufactured by Pentax, FOIF, KQGEO, ComNav, Slagen, Muya, Midland, Mileseey and disputed with the purchase contract or defects have been
...
<p>The Buyer is required to inspect the goods upon receipt from the seller. Subsequent claims related to obvious defects are not accepted by Measurement Systems Limited.</p>
