...
if ($service_request->item_type == 'Level') {
    ...
    $info_report .= '<b style="font-size:12px; color:maroon;">INSTRUMENT INFORMATION REPORT</b><br><br><br>
            <table border="0" cellpadding="5">
    ...
    $rowColor = ($lresult1 == 'Pass' && $lresult2 == 'Pass' && $lresult3 == 'Pass' && $lresult4 == 'Pass') ? 'lightgreen' : 'lightcoral';
    ...
    $info_report .= '<tr style="background-color: lightgrey;">
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2">Standard deviation (mm)</td>
    ...
    $info_report .= '<tr style="background-color: lightgrey;">
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2">Meaned Elevation differences (mm)</td>
    ...
    $info_report .= '<tr style="background-color: lightgrey;">
                                ...
                                <td></td>
                                <td></td>
                                <td colspan="2">Acceptable Standard Deviation (mm)</td>
    ...
    // Determine the row color based on results
    $rowColor2 = ($lresult5 == 'Pass' && $lresult6 == 'Pass' && $lresult7 == 'Pass'  && $lresult8 == 'Pass') ? 'lightgreen' : 'lightcoral'; // lightcoral for faded red
    ...
    $info_report = '
                    <table border="0" cellpadding="5">
                            ...
                            <thead>
                            <tr style="color:#424242;">
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>INSTRUMENT INFORMATION</b></td>
                            </tr>
                            </thead>
                            <tbody>
                            <tr class="form-inline">
    ...
    if ($d_error_v_b1_5 > $t_v_a_10 && $d_error_v_b1_5 > $t_v_a_10) {
        $resultpre = '<b style="color: black;">FAILED</b>';
    } else {
        $resultpre = '<b style="color: black;">PASSED</b>';
    }
    ...
    $info_report .= '<table border="1" cellpadding="4">
                        <tr style="color:#424242;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>PRE-CALIBRATION CHECKS</b></td>
                        </tr>
                        <tr style="color:#424242;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:center; color:red;" colspan="6"><b>INDEX ERROR CHECKS</b></td>
                        </tr>
                            <tr style="color:#424242;">
                                
                                <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:red;" colspan="3"><b>HORIZONTAL CIRCLE INDEX ERROR</b></td>
                                <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:red;" colspan="4"><b>VERTICAL CIRCLE INDEX ERROR</b></td>
                                
                            </tr>
                            <thead>
                                <tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                                    <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="">FACE</td>
                                    <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="1">START A</td>
                                    <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="1">END B</td>
                                    <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">START A</td>
                                    <td style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">END B</td>
                                </tr>
                            </thead>
                            <tbody>';
    ...
    $info_report .= '
                                <tr style="color:#424242;">
                                    ...
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="3">' . dec2dms_full($calibration_info->i_v_b) . '</td>
                                ...
                                <tr style="color:#424242;">
                                    ...
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="1">' . dec2dms_full($calibration_info->ii_h_b) . '</td>
                                ...
                                <tr style="color:#424242;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; font-weight:500;"><b>Index Error</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_a) . '</td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_b) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b1_5) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b) . '</td>
                                </tr>
                                <tr style="color:#424242;">
                                    <td class="desc" colspan="6" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; background-color: ' .
        ($resultpre === '<b style="color: black;">FAILED</b>' ? '#ffcccc' : '#ccffcc') .
        ';">' . $resultpre . '</td>
                                </tr>
                                </tbody>
                        </table><br><br>';
    ...
    $info_report .= '<table border="1" cellpadding="4">
                            <thead>
                                <tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                                    <th style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"colspan="6">EDM CHECKS</th>
                                    <th style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">Residuals from Mean(mm)</th>
                                    <th style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">Squared meaned residuals(mm)</th>
                                </tr>
                                <tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                            ...
                            <tr style="color:#424242;">
                                ...
                                <tr style="color:#424242; background-color: lightgrey;">
                                    ...
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>Sum</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . number_format($total_smdistance, 4) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . number_format($total_smelevation, 4) . '</td>
                                </tr>
                                <tr style="color:#424242; background-color: lightgrey;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    ...
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>Standard Errors</b></td>
                                ...
                                <tr style="color:#424242;">
                                    <td class="total" colspan="12" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; ' . ($standard_error1 < $t_v_a_10 && $standard_error2 < $t_v_a_10 && $dfresult1 < $t_v_a_10 && $dfresult2 < $t_v_a_10 ? 'background-color: lightgreen; color: white;' : 'background-color: red; color: white;') . '">
    ...
    if ($d_error_v_b1_6 > $t_v_a_10 && $d_error_v_b1_6 > $t_v_a_10) {
        $resultpre1 = '<b style="color: black;">FAILED</b>';
    } else {
        $resultpre1 = '<b style="color: black;">PASSED</b>';
    }
    ...
    $info_report .= '<table border="1" cellpadding="4">
                        <tr style="color:#424242;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>POST-CALIBRATION CHECKS</b></td>
                        </tr>
                        <tr style="color:#424242;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:center; color:red;" colspan="6"><b>INDEX ERROR CHECKS</b></td>
                        </tr>
                            ...
                            <thead>
                                <tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                                    <th style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="">FACE</th>
    ...
    $info_report .= '
                                <tr style="color:#424242;">
                                    ...
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($calibration_info->t_v_a) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="3">' . dec2dms_full($calibration_info->t_v_b) . '</td>
                                    
                                </tr>
                                <tr style="color:#424242;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>II</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($calibration_info->tt_h_a) . '</td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($calibration_info->tt_h_b) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($calibration_info->tt_v_a) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($calibration_info->tt_v_b) . '</td>
                                ...
                                <tr style="color:#424242;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>SUM(I+II)</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($sum_h_a2) . '</td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($sum_h_b2) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($sum_v_a2) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($sum_v_b2) . '</td>
                                </tr>
                                <tr style="color:#424242;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>DOUBLE ERROR</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_a2) . '</td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_b2) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_a2) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b2) . '</td>
                                </tr>
                                <tr style="color:#424242;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; font-weight:500;"><b>Index Error</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_a2) . '</td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_b2) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b1_6) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b2) . '</td>
                                </tr>
                                <tr style="color:#424242;">
                                    <td class="desc" colspan="6" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; background-color: ' .
        ($resultpre1 === '<b style="color: black;">FAILED</b>' ? '#ffcccc' : '#ccffcc') .
        ';">' . $resultpre1 . '</td>
                                </tr>
                                </tbody>
                        </table><br><br>';
    ...
    $info_report .= '<table border="0" cellpadding="4">
                            ...
                            <tr style="color:#424242;">
                                ...
                                <tr style="color:#424242; background-color: lightgrey;">
                                    ...
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>Sum</b></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . number_format($total_smdistance1, 4) . '</td>
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . number_format($total_smelevation1, 4) . '</td>
                                </tr>
                                <tr style="color:#424242; background-color: lightgrey;">
                                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                ...
                                <tr style="color:#424242;">
                                    <td class="total" colspan="12" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; ' . ($standard_error3 < $t_v_a_10 && $standard_error4 < $t_v_a_10 && $dfresult3 < $t_v_a_10 && $dfresult4 < $t_v_a_10 ? 'background-color: lightgreen; color: white;' : 'background-color: red; color: white;') . '">
    ...
    if ($d_error_v_a_2 > $th_v_a_9 && $d_error_v_a > $th_v_a_9) {
        // Fail case
        $result = '<b style="color:black;">FAILED</b>';
        $row_color = '#FFCCCC'; // Light red for fail
    } else {
        // Pass case
        $result = '<b style="color:black;">PASSED</b>';
        $row_color = '#CCFFCC'; // Light green for pass
    }


    $info_report .= '<table border="1" cellpadding="4">
        <tr style="color:#424242;">
            <td style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; background-color: ; border:1px solid #000; text-align:center; color:red;" colspan="6"><b>INDEX ERROR CHECKS</b></td>
        </tr>
        <tr style="color:#424242;">
            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; background-color: ; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>PRE-CALIBRATION CHECKS</b></td>
        </tr>
    ...
    $info_report .= '<tr style="color:#424242;">
                ...
                <tr style="color:#424242;">
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>SUM</b></td>
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($sum_h_a) . '</td>
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($sum_h_b) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($sum_v_a) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($sum_v_b) . '</td>
                ...
                <tr style="color:#424242;">
                    ...
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_a) . '</td>
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_b) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_a_2) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b) . '</td>
                </tr>
                <tr style="color:#424242; background-color: ' . $row_color . ';">
                    <td class="total" style="' . $fontStyle . ';text-align:center; color: black;" colspan="8">
                        ' . $result . '
                    </td>
                </tr>
                </tbody>
    ...
    if ($d_error_v_b1_4 > $th_v_a_9 && $d_error_v_a1 > $th_v_a_9) {
        // Fail case
        $result1 = '<b style="color:black;">FAILED</b>';
        $row_color1 = '#FFCCCC'; // Light red for fail
    } else {
        // Pass case
        $result1 = '<b style="color:black;">PASSED</b>';
        $row_color1 = '#CCFFCC'; // Light green for pass
    }
    ...
    $info_report .= '
                ...
                <tr style="color:#424242;">
                    ...
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_a1) . '</td>
                    <td class="total" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . dec2dms_full($d_error_h_b1) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b1_4) . '</td>
                    <td class="desc" style="vertical-align: middle; font-size:' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . dec2dms_full($d_error_v_b1) . '</td>
                </tr>
                <tr style="color:#424242; background-color: ' . $row_color1 . ';">
                    <td class="total" style="' . $fontStyle . ';text-align:center; color: black;" colspan="8">
                        ' . $result1 . '
                    </td>
                </tr>
...
} else if ($service_request->item_type == 'GNSS') {
    // Assuming the form is submitted via POST
    ...
    // PRE-CALIBRATIO REPORT
    $info_report .= '<table border="0" cellpadding="5">
                <thead>';
    $info_report .= '<tr bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                    <th style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>PRE-CALIBRATION CHECKS</b></th>
                    <th style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:red;" colspan="9"><b>MEASUREMENTS</b></th>
                </tr>';
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($i_v_a_1) . '</td>
    ...
    // Determine the background color based on the pass/fail status000000000
    $background_color = (
    ...
    // $deviation_check = (
    //     ($standarddeviationresult1 < $r_v_a_10) &&
    //     ($squaredeastingresult3 < $r_v_a_11)
    // ) ? 'PASSED' : 'FAILED';
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td colspan="2" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"><b>Averaged</b></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue11a) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue12a) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue13a) . '</td>
                            <td colspan="2" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">SUM</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">SUM</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1A, 4) . '</b></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1B, 4) . '</b></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1C, 4) . '</b></td>
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">
                            ...
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue14a) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue15a) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue16a) . '</td>
    ...
    // Dynamically assign the row style and content based on the result
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">   
                        <td colspan="16" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; background-color: ' .
        ($overall_check === 'PASSED' ? 'lightgreen' : 'lightcoral') . ';">
                            ' . $overall_check . '
                        </td>
                        </tr>
    ...
    // POST-CALIBRATIO REPORT
    $info_report .= '<table border="0" cellpadding="5">
                    <tr style="color:#424242;">
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>POST-CALIBRATION CHECKS</b></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:red;" colspan="9"><b>MEASUREMENTS</b></td>
                    </tr>
                    <thead>';
    $info_report .= '<tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                                        <th style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">Series</th>
                                    ...
                                    <tr style="color:#424242;">
                                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:red;" colspan="2"><b>START TIME:' . (!empty($calibration_info->start_time_4) ? date('H:i A', strtotime($calibration_info->start_time_4)) : 'N/A') . '</b></td>
                                    </tr>';
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting1aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting1bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting1cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue1aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue1bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue1cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue1a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue6a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting2aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting2bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting2cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue2aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue2bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue2cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting3aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting3bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting3cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue3aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue3bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue3cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue2a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue7a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting4aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting4bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting4cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue4aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue4bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue4cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting5aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting5bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting5cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue5aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue5bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue5cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue3a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue8a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting6aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting6bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting6cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue6aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue6bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue6cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting7aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting7bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting7cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue7aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue7bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue7cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue4a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue9a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting8aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting8bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting8cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue8aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue8bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue8cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting9aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting9bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting9cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue9aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue9bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue9cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue5a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue10a . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting10aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting10bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting10cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue10aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue10bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue10cc, 3) . '</td>

                        </tr>
                        <tr style="color:#424242;">
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="2"><b>STOP TIME:' . (!empty($calibration_info->stop_time_4) ? date('H:i A', strtotime($calibration_info->stop_time_4)) : 'N/A') . '</b></td>
                        </tr>
                        <tr style="color:#424242;">
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="2"><b>START TIME:' . (!empty($calibration_info->start_time_5) ? date('H:i A', strtotime($calibration_info->start_time_5)) : 'N/A') . '</b></td>
                        </tr><br>';
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($i_v_bb_1, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $i_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $i_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting11aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting11bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting11cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue11aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue11bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue11cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue1bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue6bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting12aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting12bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting12cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue12aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue12bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue12cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting13aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting13bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting13cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue13aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue13bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue13cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue2bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue7bb . '</td>            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting11aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting14bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting14cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue14aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue14bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue14cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">3</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting15aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting15bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting15cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue15aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue15bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue15cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">3</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue3bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue8bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting16aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting16bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting16cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue16aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue16bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue16cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">4</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting17aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting17bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting17cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue17aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue17bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue17cc, 3) . '</td>
                        </tr>';
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">4</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue4bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue9bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting18aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting18bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting18cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue18aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue18bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue18cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">5</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting19aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting19bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting19cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue19aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue19bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue19cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                        ...
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">5</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_bb_1 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_bb_2 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_bb_3 . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue5bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue10bb . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting20aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting20bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting20cc, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue20aa, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue20bb, 3) . '</td>
                        <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue20cc, 3) . '</td>
                        ...
                        <tr style="color:#424242;">
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="2"><b>STOP TIME:' . (!empty($calibration_info->stop_time_5) ? date('H:i A', strtotime($calibration_info->stop_time_5)) : 'N/A') . '</b></td>
                        </tr>
    ...
    $info_report .= '<tr height="30" bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight:bold; font-size:' . (get_option('pdf_font_size') + 4) . 'px;">
                            ...
                            <tr style="color:#424242;">
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="2"><b>START TIME:' . (!empty($calibration_info->start_time_6) ? date('H:i A', strtotime($calibration_info->start_time_6)) : 'N/A') . '</b></td>
                            </tr>
                            ';
    ...
    $sumValue171 = round($sumValue1aa + $sumValue2aa + $sumValue3aa + $sumValue4aa + $sumValue5aa + $sumValue1bb + $sumValue2bb + $sumValue3bb + $sumValue4bb + $sumValue5bb + $sumValue1cc + $sumValue2cc + $sumValue3cc + $sumValue4cc + $sumValue5c, 2);
    ...
    $sumValue191 = round(($sumValue171) / 15, 3);
    // $sumValue19 = 19.995;
    $sumValue201 = round(($sumValue181) / 15, 3);
    // $sumValue20 = 0.028;
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($i_v_cc_1, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $i_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $i_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting21aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting21bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting21cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue21aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue21bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue21cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $ii_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue1cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue6cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting22aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting22bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting22cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue22aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue22bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue22cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iii_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting23aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting23bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting23cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue23aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue23bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue23cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $iv_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue2cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue7cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting24aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting24bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting24cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue24aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue24bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue24cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">3</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $v_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting25aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting25bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting25cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue25aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue25bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue25cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">3</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vi_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue3cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue8cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting26aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting26bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting26cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue26aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue26bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue26cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">4</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $vii_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting27aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting27bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting27cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue27aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue27bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue27cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">4</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $viii_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue4cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue9cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting28aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting28bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting28cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue28aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue28bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue28cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">5</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">1</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $xi_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting29aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting29bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting29cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue29aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue29bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue29cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:#424242;">
                                ...
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">5</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">2</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_cc_1 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_cc_2 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $x_v_cc_3 . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue5cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $sumValue10cc . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting30aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting30bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($residualEasting30cc, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue30aa, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue30bb, 3) . '</td>
                                <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredValue30cc, 3) . '</td>
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td colspan="2" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">Averaged</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue11b) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue12b, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . ($sumValue13b) . '</td>
                            <td colspan="2" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">SUM</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">SUM</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1A, 3) . '</b></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1B, 3) . '</b></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; color:;" colspan=""><b>' . round($sumSquaredValues1C, 3) . '</b></td>
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">
                            ...
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue14b, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue15b, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue16b, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue171, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue181, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredeastingresult4, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredeastingresult5, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredeastingresult6, 3) . '</td>
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">
                            ...
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td colspan="4" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:right;">Horizontal Distance/Elevation Accuracy</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue191, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($sumValue201, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;"></td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">Standard Deviation</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;" colspan="2">' . round($standarddeviationresult2, 3) . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . round($squaredeastingresult6, 3) . '</td>
    ...
    $info_report .= '<tr style="color:; background-color: lightgrey; font-weight: bold;">   
                        <td colspan="16" style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center; background-color: ' .
        ($overall_check1 === 'PASSED' ? 'lightgreen' : 'lightcoral') . ';">
                            ' . $overall_check1 . '
                        </td>
                        </tr>
                <tbody>
...
} else if ($service_request->item_type == 'lasers') {
    $ls_v_a_1 = $calibration_info->ls_v_a_1;
    $ls_v_a_2 = $calibration_info->ls_v_a_2;
    $ls_v_a_3 = $calibration_info->ls_v_a_3;
    $ls_v_a_4 = $calibration_info->ls_v_a_4;
    $ls_v_a_5 = $calibration_info->ls_v_a_5;
    $ls_v_a_6 = $calibration_info->ls_v_a_6;
    $ls_v_a_7 = $calibration_info->ls_v_a_7;
    $ls_v_a_8 = $calibration_info->ls_v_a_8;
    $ls_v_a_9 = $calibration_info->ls_v_a_9;
    ...
    $info_report .= '<b style="font-size:12px; color:maroon;">INSTRUMENT INFORMATION REPORT</b><br><br>
                <table border="0" cellpadding="5">
                    ...
                    <thead>
                        <tr style="color:#424242;">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:left; color:red;" colspan="6"><b>INSTRUMENT INFORMATION</b></td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="form-inline">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">INSTRUMENT MAKE</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_1 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">INSTRUMENT MODEL</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_2 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">INSTRUMENT SERIAL NO.</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_3 . '</td>
                        </tr>

                        <tr class="form-inline">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">INSTRUMENT CONDITION</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_4 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">TEST DISTANCE (M)</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_5 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">MANUFACTURER EDM ACCURACY (MM)</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_6 . '</td>
                        </tr>

                        <tr class="form-inline">
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">WEATHER CONDITION</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_7 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">TEMPERATURE (°C)</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_8 . '</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">AIR PRESSURE (hPa)</td>
                            <td style="vertical-align: middle; font-size: ' . ($font_size + 2) . 'px; border:1px solid #000; text-align:center;">' . $calibration_info->ls_v_a_9 . '</td>
                        </tr>
    ...
    $info_report .= '<b style="font-size:12px; color:maroon;">PRE-CALIBRATION REPORT</b><br><br>
                <table border="1" cellpadding="4">
                    <thead>
                        <tr>
                            <th colspan="3" style="text-align:center; color:red; font-weight:500;">HORIZONTAL HEIGHT (UP AND DOWN DEVIATION) ACCURACY ERROR</th>
                            <th colspan="3" style="text-align:center; color:red; font-weight:500;">HORIZONTAL LEVEL (SIDE TO SIDE INCLINATION) ACCURACY ERROR</th>
                        </tr>
                        <tr>
                            <th style="text-align:center; font-weight:500;"></th>
                            <th style="text-align:center; font-weight:500;">OBSERVATIONS</th>
                            <th style="text-align:center; font-weight:500;"></th>
                            <th style="text-align:center; font-weight:500;"></th>
                            <th style="text-align:center; font-weight:500;">OBSERVATIONS</th>
                            <th style="text-align:center; font-weight:500;"></th>
                        ...
                        <tr>
                            <th style="text-align:center; font-weight:500;">Station</th>
                            <th style="text-align:center; font-weight:500;">BS A(mm)</th>
                            <th style="text-align:center; font-weight:500;">FS B(mm)</th>
                            <th style="text-align:center; font-weight:500;">Station</th>
                            <th style="text-align:center; font-weight:500;">A(mm)</th>
                            <th style="text-align:center; font-weight:500;">B(mm)</th>
                        </tr>
                    </thead>
                    <tbody>';
    ...
    $info_report .= '<tr>
                        ...
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_bsa1 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_fsa1 . '</td>
                        <td style="text-align:center; font-weight:500;">1</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hl_bsa1 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hl_fsa1 . '</td>
                    </tr>';

    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">2</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_bsa2 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_fsa2 . '</td>
                        <th colspan="3" style="text-align:center; font-weight:500;">VERTICAL LEVEL (SIDE TO SIDE INCLINATION) ACCURACY ERROR<br>OBSERVATIONS</th>
                    </tr>';

    $lsresult1 = $calibration_info->hh_bsa1 - $calibration_info->hh_bsa2;
    $lsresult2 = $calibration_info->hh_fsa1 - $calibration_info->hh_fsa2;
    $lsresult7 = $calibration_info->hl_bsa1 - $calibration_info->hl_fsa1;
    $lsresult8 = $calibration_info->vl_bsa1 - $calibration_info->vl_fsa1;

    $lsdistance1 = $lsresult1 - $lsresult2;

    $hhbackgroundColor = ($lsdistance1 < $calibration_info->ls_v_a_6) ? 'lightgreen' : 'lightcoral';
    $hvlbackgroundColor = ($lsresult7 < $calibration_info->ls_v_a_6 && $lsresult8 < $calibration_info->ls_v_a_6) ? 'lightgreen' : 'lightcoral';

    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">Difference (mm)</td>
                        <td style="text-align:center; font-weight:500;">' . $lsresult1 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $lsresult2 . '</td>
                        <td style="text-align:center; font-weight:500;">1</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->vl_bsa1 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->vl_fsa1 . '</td>
                    </tr>';

    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">Distance (mm)</td>
                        <td colspan="2" style="text-align:center; font-weight:500; background-color:' . $hhbackgroundColor . ';">
                        ' . ((isset($lsresult1) && isset($lsresult2)) ? ($lsresult1 - $lsresult2) : 'N/A') . '
                        </td>                        
                        <td style="text-align:center; font-weight:500;">Distance E (mm)</td>
                        <td colspan="2" style="text-align:center; font-weight:500; background-color:' . $hvlbackgroundColor . ';">
                        ' . ((isset($calibration_info->vl_bsa1) && isset($calibration_info->vl_fsa1)) ? ($calibration_info->vl_bsa1 - $calibration_info->vl_fsa1) : 'N/A') . '
                        </td>                    
                    </tr>
                    </tbody>
            </table><br><br>';
    ...
    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">1</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_bsa3 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_fsa3 . '</td>
                        <td style="text-align:center; font-weight:500;">1</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hl_bsa2 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hl_fsa2 . '</td>
                    </tr>';

    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">2</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_bsa4 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->hh_fsa4 . '</td>
                        <th colspan="3" style="text-align:center; font-weight:500;">VERTICAL LEVEL (SIDE TO SIDE INCLINATION) ACCURACY ERROR<br>OBSERVATIONS</th>
                    </tr>';

    $lsresult3 = $calibration_info->hh_bsa3 - $calibration_info->hh_bsa4;
    $lsresult4 = $calibration_info->hh_fsa3 - $calibration_info->hh_fsa4;
    $lsresult5 = $calibration_info->hl_bsa2 - $calibration_info->hl_fsa2;
    $lsresult6 = $calibration_info->vl_bsa2 - $calibration_info->vl_fsa2;

    $lsdistance2 = $lsresult3 - $lsresult4;

    $hhbackgroundColor1 = ($lsdistance2 < $calibration_info->ls_v_a_6) ? 'lightgreen' : 'lightcoral';
    $hvlbackgroundColor1 = ($lsresult5 < $calibration_info->ls_v_a_6 && $lsresult6 < $calibration_info->ls_v_a_6) ? 'lightgreen' : 'lightcoral';
    ...
    $info_report .= '<tr>
                        <td style="text-align:center; font-weight:500;">Difference (mm)</td>
                        <td style="text-align:center; font-weight:500;">' . $lsresult3 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $lsresult4 . '</td>
                        <td style="text-align:center; font-weight:500;">1</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->vl_bsa2 . '</td>
                        <td style="text-align:center; font-weight:500;">' . $calibration_info->vl_fsa2 . '</td>
                    </tr>';

    $info_report .= '<tr style="background-color:;">
                    <td style="text-align:center; font-weight:500;">Distance (mm)</td>
                    <td colspan="2" style="text-align:center; font-weight:500; background-color:' . $hhbackgroundColor1 . ';">
                        ' . ((isset($lsresult3) && isset($lsresult4)) ? ($lsresult3 - $lsresult4) : 'N/A') . '
                    </td>
                    <td style="text-align:center; font-weight:500;">Distance E (mm)</td>
                    <td colspan="2" style="text-align:center; font-weight:500; background-color:' . $hvlbackgroundColor1 . ';">
                        ' . ((isset($calibration_info->vl_bsa2) && isset($calibration_info->vl_fsa2)) ? ($calibration_info->vl_bsa2 - $calibration_info->vl_fsa2) : 'N/A') . '
                    </td>
                </tr>
...
$pdf->MultiCell(($dimensions['wk']) - $dimensions['rm'] - $dimensions['lm'], 0, $info_report, 0, 'H', 0, 1, '', '', true, 0, true, false, 0);
$pdf->ln(5);
        ...
        <table cellpadding="0">
           <tr>
            ...
            <td style="vertical-align: middle; text-align:center; padding-top: 10px;">
                    ' . show_verification_qrcode(['verificationUrl' => site_url('service/report/view/' . $service_request_code->service_request_code)]) . '
            </td>
        </tr>
        </table>';
...
$footer_thank_msg = '
            <table border="0" cellpadding="5" style="width:100%; text-align:center;">
        <thead>
            <tr>
                <td style="vertical-align: middle; text-align:center; font-size: ' . ($font_size + 4) . 'px; border-top:2px solid #dedede;">
                    <b>' . strtoupper("Thank You For Your Business") . '</b>
                </td>
            </tr>
        </thead>
        <tbody>            
...
// Embed the footer content into the PDF
