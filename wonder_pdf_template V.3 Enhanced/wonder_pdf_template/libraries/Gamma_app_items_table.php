...
class Gamma_app_items_table extends App_items_table_template {
	...
	public function items() {
		...
		foreach ($this->items as $item) {
			$border = 'border-bottom-color:#000000;border-bottom-width:1px; border-bottom-style:solid; font-size:12px; ';
	...
	public function pdf_headings() {
		...
		$tblhtml = '<tr height="30" bgcolor="#fff" style="font-weight:bold; font-size:10pt; color:red">';
