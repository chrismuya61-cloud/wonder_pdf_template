...
$heading = '<span style="font-weight:bold;font-size:27px; text-align:center;"><u>SERVICE REQUEST</u></span>';
...
$info_instrument_condition = '
    <table  border="0" cellpadding="5">
      <thead>
        <tr bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight: bold;">
          <td style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;"><b>CONDITION OF INSTRUMENT</b></td>
        </tr>
      </thead>
      <tbody>
        <tr style="color:#424242;">
          <td style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;">' . $service_request->condition . '</td>
        </tr>
      </tbody>
    </table>';
...
$info_service_details = '
    <table  border="0" cellpadding="5">
      <thead>
        <tr bgcolor="' . get_option('pdf_table_heading_color') . '" style="color:' . get_option('pdf_table_heading_text_color') . '; font-weight: bold;">
          <td width="5%;" align="center" style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;"><b>#</b></td>
          <td width="35%"  align="left;" style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;"><b>EQUIPMENT</b></td>
          <td width="35%" align="left;" style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;"><b>SERVICE</b></td>
          <td width="25%" align="right"  style="vertical-align: middle; font-size: ' . ($font_size + 4) . 'px; border:1px solid #ccc;"><b>TOTAL PRICE (' . get_default_currency('symbol') . ')</b></td>
        </tr>
      </thead>
      <tbody>';
...
foreach ($service_request_details as $key => $detail_info) {
	...
	$info_service_details .= '
        <tr' . $tr_attrs . ' ' . $bg . ' >
          ...
          <td width="25%" align="right" style="border:1px solid #ccc;">' . app_format_money($detail_info->price, '') . '</td>
        </tr>';
...
$info_service_details .= '
      <tr>
          ...
          <td align="right" width="25%" style="border:1px solid #ccc;" bgcolor="#f4f4f4">' . app_format_money($total, get_default_currency('symbol')) . '</td>
      </tr>';
...
$info_sales_person .= '<td style="vertical-align: middle; font-size: '.($font_size+4).'px; border:1px solid #ccc;"># ' . $request_number . '</td><td style="vertical-align: middle; font-size: '.($font_size+4).'px; border:1px solid #ccc;">' . _d($service_request->collection_date).'</td>';
