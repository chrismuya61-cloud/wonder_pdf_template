...
$header = '<img src="' . base_url() . '/assets/images/pdf_templates/background/header_bg.png" />';
$pdf->MultiCell(220, 0, $header, 0, 'R', 0, 1, '', '', true, 0, true, false, 0);

// set bacground image
//$img_file = FCPATH . '/assets/images/pdf_templates/background/geoid_bg.jpg';
...
$heading = '<h1 style="padding:0; margin:0; font-size:18px; text-align:center;"><u>' . _l('estimate_pdf_heading') . '</u></h1>';
...
$footer = '<img src="' . base_url() . '/assets/images/pdf_templates/background/footer_bg.png" />';
$pdf->MultiCell(220, 0, $footer, 0, 'R', 0, 1, '', '', true, 0, true, false, 0);
